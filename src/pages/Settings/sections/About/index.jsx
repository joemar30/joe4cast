        ...
        <div className="settings-section animate-fade-in about-section">
            ...
            <div className="about-hero-card">
                ...
                <div className="hero-actions">
                    <a href="https://github.com/joemar30/joe4cast" target="_blank" rel="noopener noreferrer" className="hero-btn btn-sponsor">
                        <Star size={16} className="btn-icon" /> Star Repo
                    </a>
                    <a href="https://github.com/joemar30/joe4cast" target="_blank" rel="noopener noreferrer" className="hero-btn btn-github">
            ...
            <div className="about-action-cards">
                <a href="https://github.com/joemar30/joe4cast/issues" target="_blank" rel="noopener noreferrer" className="action-card warning-card">
                ...
                <a href="https://github.com/joemar30/joe4cast/releases" target="_blank" rel="noopener noreferrer" className="action-card info-card">
                    <div className="card-content">
            ...
            <div className="about-footer-card">
                <div className="footer-section">
                    ...
                    <div className="social-links">
                        <a href="https://github.com/joemar30/joe4cast" target="_blank" rel="noopener noreferrer" className="social-icon" title="GitHub">
                            <Github size={18} />
                        </a>
                    </div>
                </div>
