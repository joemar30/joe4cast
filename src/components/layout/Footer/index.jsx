        ...
        <footer className="site-footer">
            <div className="site-footer__inner">
                ...
                <div className="footer-top">
                    <button className="footer-logo" onClick={() => navigate('/')} aria-label="Joe4cast Home">
                        <img src="/joe4cast.png" alt="Joe4cast" className="footer-logo__img" />
                        <span className="footer-logo__text">
                            <span className="footer-logo__vibe">JOE4</span>
                            <span className="footer-logo__o">CAST</span>
                        </span>
                    </button>
                    ...
                    <div className="footer-socials">
                        {/* GitHub */}
                        <a href="https://github.com/ADET-AI-Assistant/Joe4cast" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="GitHub">
                ...
                <div className="footer-bottom">
                    <p className="footer-disclaimer">
                        Joe4cast does not store any files on our server, we only linked to the media which is hosted on 3rd party services.
                    </p>
                    <p className="footer-copyright">© {new Date().getFullYear()} joe4cast. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
